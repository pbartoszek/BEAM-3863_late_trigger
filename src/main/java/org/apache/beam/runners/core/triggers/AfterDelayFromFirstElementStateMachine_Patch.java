...
/*
 *
 *  PATCHED CLASS. Please check {@code #shouldFire} method for fix
    Please see https://issues.apache.org/jira/browse/BEAM-3863 for details.
 */
...
public abstract class AfterDelayFromFirstElementStateMachine_Patch extends TriggerStateMachine {

  private static final Logger LOG = LoggerFactory.getLogger(AfterDelayFromFirstElementStateMachine_Patch.class);

  static {
    LOG.warn("This is a patched class. See https://issues.apache.org/jira/browse/BEAM-3863 for details");
  }
   ...
   */
  @Nullable
  public abstract Instant getCurrentTime(TriggerContext context);
   ...
   */
  protected abstract AfterDelayFromFirstElementStateMachine_Patch newWith(
  ...
  public AfterDelayFromFirstElementStateMachine_Patch(
   ...
   * CalendarWindows.
   */
  public AfterDelayFromFirstElementStateMachine_Patch alignedTo(
   ...
   * since the epoch.
   */
  public AfterDelayFromFirstElementStateMachine_Patch alignedTo(final Duration size) {
   ...
   */
  public AfterDelayFromFirstElementStateMachine_Patch plusDelayOf(final Duration delay) {
  ...
  public boolean isCompatible(TriggerStateMachine other) {
    ...
    AfterDelayFromFirstElementStateMachine_Patch that = (AfterDelayFromFirstElementStateMachine_Patch) other;
    return this.timestampMappers.equals(that.timestampMappers);
  }


  private AfterDelayFromFirstElementStateMachine_Patch newWith(
  ...
  public boolean shouldFire(TriggerContext context) throws Exception {
    ...
    // https://issues.apache.org/jira/browse/BEAM-3863 - checking if delayedUntil is equal to  currentTime
